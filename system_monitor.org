...
#+END_QUOTE
#+BEGIN_QUOTE
$Bus\ Input\ Filter\ Time[s] = System\ Clock\ period[s] \times \frac{BHM\_CLKPSC+1}{8}$
#+END_QUOTE
BHM_CLKPSCの設定値が 0x0800以上の場合は、Bus Input Filter Timeはシステムクロック 256サイクルの時間に固定されます。
...
| Bus Input Filter Time                | 60 Cycle [1250ns]           | 30 Cycle [1250ns]      |
